      ...
      <Router>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/closing/monthly" element={<Layout><MonthlyClosing /></Layout>} />
            <Route path="/salaries" element={<Layout><Salaries /></Layout>} />
            <Route path="/salaries/manage" element={<Layout><SalaryManagement /></Layout>} />
            ...
            <Route path="/onboarding/tax" element={<Layout><TaxOnboarding /></Layout>} />
          </Routes>
        </AuthProvider>
      </Router>
    </div>
